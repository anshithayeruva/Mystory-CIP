  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <p className={styles.subtitle}>Manage your student account information, security, and personal preferences.</p>
      </header>
      ...
      <section className={styles.card}>
        ...
        <div style={{ borderTop: "1px solid #f1f5f9", paddingTop: "24px" }}>
          ...
          <p style={{ fontSize: "14px", color: "#64748b", margin: "0 0 16px 0" }}>Add an extra layer of security to your student account.</p>
      ...
      <section className={styles.card}>
        ...
        <div className={styles.toggleRow}>
          <div className={styles.toggleInfo}>
            <span className={styles.toggleTitle}>Timetable & Class Reminders</span>
            <span className={styles.toggleDesc}>Get notified 15 minutes before scheduled lectures and practical sessions</span>
          </div>
          <div 
            className={`${styles.toggleSwitch} ${toggles.timetable ? styles.active : ""}`}
            onClick={() => {
              setToggles({...toggles, timetable: !toggles.timetable});
              triggerToast("Notification setting updated!");
            }}
          >
            <div className={styles.toggleKnob}></div>
        ...
        <div className={styles.toggleRow}>
          <div className={styles.toggleInfo}>
            ...
            <span className={styles.toggleDesc}>Instant alerts when course attendance drops below 75%</span>
          </div>
          <div 
        ...
        <div className={styles.toggleRow}>
          <div className={styles.toggleInfo}>
            <span className={styles.toggleTitle}>Digital Resource Alerts</span>
            <span className={styles.toggleDesc}>Receive alerts when new study materials or slides are uploaded</span>
          </div>
          <div 
            className={`${styles.toggleSwitch} ${toggles.resourceUploads ? styles.active : ""}`}
            onClick={() => {
              setToggles({...toggles, resourceUploads: !toggles.resourceUploads});
              triggerToast("Notification setting updated!");
            }}
          >
            <div className={styles.toggleKnob}></div>
      ...
      <section className={styles.card}>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            {[
              { date: "Aug 01, 2026, 12:02 PM", device: "Chrome on Windows (Current)", loc: "SRM AP Campus", status: "Active Now" },
              { date: "Jul 31, 2026, 4:15 PM", device: "Chrome on Windows", loc: "SRM AP Campus", status: "Successful" },
              { date: "Jul 30, 2026, 11:05 AM", device: "Safari on macOS", loc: "Amaravati, India", status: "Successful" },
              { date: "Jul 29, 2026, 8:50 AM", device: "Chrome on Windows", loc: "SRM AP Campus", status: "Successful" },
            ].map((item, i) => (
              <tr key={i}>
                <td>{item.date}</td>
                <td>{item.device}</td>
      ...
      <section className={styles.card} style={{ backgroundColor: "#f8fafc", border: "1px dashed #cbd5e1" }}>
        ...
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoItem}>
            ...
            <span className={styles.infoValue}>Student (B.Tech CSE)</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Member Since</span>
            <span className={styles.infoValue}>August 2023</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Last Login</span>
            <span className={styles.infoValue}>Today, 12:02 PM</span>
          </div>
        </div>
      </section>
    </div>
