  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", alignItems: "center", height: "80vh", backgroundColor: "#f8fafc", borderRadius: "12px", border: "1px dashed #cbd5e1" }}>
      <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
        ...
        <h2 style={{ fontSize: "1.5rem", fontWeight: 700, color: "#0f172a", margin: 0 }}>Live Classroom (Pulse)</h2>
        <p style={{ color: "#64748b", maxWidth: "400px" }}>The live interactive classroom sessions module is currently under construction.</p>
      </div>
    </div>
  );
}
