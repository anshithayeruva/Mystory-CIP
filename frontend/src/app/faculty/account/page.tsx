...
export default function FacultyAccountPage() {
  ...
  const [profile, setProfile] = useState({
    ...
    staffId: "FAC-CSE-84920",
    office: "Building B, Room 402 (Fourth Floor)",
  ...
  return (
    <div className={styles.container}>
      ...
      <header className={styles.header}>
        ...
        <p className={styles.subtitle}>Manage your faculty account information, security, and personal preferences.</p>
      </header>
      ...
      <section className={styles.card}>
        ...
        <div style={{ borderTop: "1px solid #f1f5f9", paddingTop: "24px" }}>
          ...
          <p style={{ fontSize: "14px", color: "#64748b", margin: "0 0 16px 0" }}>Add an extra layer of security to your Faculty account.</p>
      ...
      <section className={styles.card}>
        ...
        <div className={styles.toggleRow}>
          <div className={styles.toggleInfo}>
            <span className={styles.toggleTitle}>Pulse Session Reminders</span>
            <span className={styles.toggleDesc}>Get notified 15 minutes before scheduled teaching sessions</span>
          </div>
          <div 
            className={`${styles.toggleSwitch} ${toggles.sessionReminders ? styles.active : ""}`}
            onClick={() => {
              setToggles({...toggles, sessionReminders: !toggles.sessionReminders});
              triggerToast("Notification setting updated!");
            }}
          >
            <div className={styles.toggleKnob}></div>
        ...
        <div className={styles.toggleRow}>
          <div className={styles.toggleInfo}>
            ...
            <span className={styles.toggleDesc}>Instant alerts when course section attendance drops below 75%</span>
          </div>
          <div 
        ...
        <div className={styles.toggleRow}>
          <div className={styles.toggleInfo}>
            <span className={styles.toggleTitle}>Weekly Teaching Digest</span>
            <span className={styles.toggleDesc}>Receive weekly class performance and understanding summaries via email</span>
          </div>
          <div 
      ...
      <section className={styles.card}>
        ...
        <table className={styles.table}>
          ...
          <tbody>
            {[
              { date: "Jul 31, 2026, 6:30 PM", device: "Chrome on Windows (Current)", loc: "SRM AP Campus", status: "Active Now" },
              { date: "Jul 30, 2026, 2:15 PM", device: "Chrome on Windows", loc: "SRM AP Campus", status: "Successful" },
              { date: "Jul 29, 2026, 10:05 AM", device: "Safari on macOS", loc: "Amaravati, India", status: "Successful" },
              { date: "Jul 28, 2026, 9:20 AM", device: "Chrome on Windows", loc: "SRM AP Campus", status: "Successful" },
            ].map((item, i) => (
              <tr key={i}>
                <td>{item.date}</td>
                <td>{item.device}</td>
      ...
      <section className={styles.card} style={{ backgroundColor: "#f8fafc", border: "1px dashed #cbd5e1" }}>
        ...
        <div className={styles.infoGrid}>
          ...
          <div className={styles.infoItem}>
            ...
            <span className={styles.infoValue}>Associate Professor (CSE)</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Member Since</span>
            <span className={styles.infoValue}>August 2022</span>
          </div>
          <div className={styles.infoItem}>
            <span className={styles.infoLabel}>Last Login</span>
            <span className={styles.infoValue}>Today, 6:30 PM</span>
          </div>
        </div>
      </section>
    </div>
