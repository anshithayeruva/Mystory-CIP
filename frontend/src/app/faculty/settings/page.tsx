...
export default function FacultySettingsPage() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      ...
      case "subject":
        return <SubjectConfiguration formData={subjectConfig} onToggle={handleSubjectToggle} onSelect={handleSubjectSelect} />;
      case "assessment":
        return <AssessmentConfiguration formData={assessmentConfig} onToggle={handleAssessmentToggle} onSelect={handleAssessmentSelect} />;
      case "notifications":
        return <NotificationSettings formData={notifications} onToggle={handleNotificationToggle} onSelect={handleNotificationSelect} />;
      case "reports":
        return <ReportsPreferences formData={reportsPrefs} onToggle={handleReportsToggle} onSelect={handleReportsSelect} />;
      case "security":
        return <SecuritySettings formData={securityPrefs} onToggle={handleSecurityToggle} />;
      default:
        return null;
    }
  };
